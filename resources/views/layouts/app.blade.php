...
<head>
    ...
    /* Anda dapat menambahkan aturan CSS lain untuk ukuran yang berbeda */
    @media (min-width: 768px) {
        .custom-logo-size {
            width: 300px;
            /* Ukuran lebih besar untuk layar yang lebih lebar */
        }
    }
    </style>
</head>
        ...
        <header class="navbar navbar-expand-md d-print-none">
            <div class="container-xl">
                ...
                <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                    <a href="{{ route('front') }}">
                        <img src="{{ asset('images/Logo-Brand-2.png') }}" alt="Logo Brand 2"
                            class="navbar-brand-image custom-logo-size">
                    </a>
                </h1>
                ...
                <div class="navbar-nav flex-row order-md-last">
                        ...
                        <div class="btn-list">
                            <a href="{{ route('loginCompany') }}" class="btn" rel="noreferrer">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="red" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <div class="nav-item dropdown">
                        <a href="{{ route('loginJobSeeker') }}" class="nav-link d-flex lh-1 text-reset p-0"
                            ...
                            <div class="d-none d-xl-block ps-2 mt-2">
                                <div>
                                    {{ $jobSeeker->job_seeker_name ?? 'Login' }}
                                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 animate__animated animate__fadeInLeft">
                        ...
                        <ul class="list-unstyled">
                            <li>
                                ...
                                ppid.disnakertransbanten@gmail.com
                            </li>
                            <li>
                                <i class="fas fa-phone me-2"></i>Telepon: (0254) 267100/111
                            </li>
                            <li>
                                <i class="fas fa-map-marker-alt me-2"></i>Kawasan Pusat Pemerintahan Provinsi Banten
                                (KP3B) Jl. KH.Syech Nawawi
                                Al-Bantani Palima Kota Serang
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-3 animate__animated animate__fadeInLeft">
                    ...
                    <div class="col-md-3 animate__animated animate__fadeInRight">
                        ...
                        <ul class="list-unstyled">
                            <li>
                                <a href="{{ route('jobs') }}" class="text-white"><i class="fas fa-search me-2"></i>Cari
                                    pekerjaan</a>
                            </li>
                            <li>
                                <a href="{{ route('jobs') }}" class="text-white"><i
                                        class="fas fa-file-alt me-2"></i>Lamar Pekerjaan</a>
                            </li>
                            <li>
                                <a href="{{ route('savedJobs') }}" class="text-white"><i
                                        class="fas fa-info me-2"></i>Lihat
                                    Status Lamaran</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-3 animate__animated animate__fadeInRight">
                        ...
                        <ul class="list-unstyled">
                            <li>
                                <a href="#" class="text-white"><i class="fas fa-briefcase me-2"></i>Buat Lowongan
                                    Kerja</a>
                            </li>
                            <li>
                                <a href="#" class="text-white"><i class="fas fa-search me-2"></i>Kelola Lamaran
                                    Masuk</a>
                            </li>
                            <li>
                                <a href="#" class="text-white"><i class="fas fa-tachometer-alt me-2"></i>Dashboard
                                    Perusahaan</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                        <ul class="list-inline list-inline-dots mb-0">
                            <li class="list-inline-item">
                                Copyright &copy; 2024
                                <a href="https://github.com/LOGsinEX" class="link-secondary">Muhamad Chikal Efendi</a>. All rights reserved.
                            </li>
                        </ul>
                    </div>
                </div>
